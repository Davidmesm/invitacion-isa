...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:ring-offset-purple-950 dark:focus-visible:ring-purple-300",
  {
    variants: {
      variant: {
        default: "bg-purple-700 text-purple-50 hover:bg-purple-700/80 dark:bg-purple-50 dark:text-purple-900 dark:hover:bg-purple-50/90",
        destructive:
